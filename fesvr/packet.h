...
enum
{
  ...
  HTIF_CMD_DOWNLOAD_HART_FULL_STATE,
  HTIF_CMD_UPLOAD_HART_FULL_STATE,
  HTIF_CMD_READ_HART_EXEC_CONTROL_REG,
  HTIF_CMD_WRITE_HART_EXEC_CONTROL_REG,
  HTIF_CMD_DOWNLOAD_MEM_DUMP,
  HTIF_CMD_UPLOAD_MEM_DUMP,
  HTIF_CMD_ACK,
  HTIF_CMD_NACK,
};
