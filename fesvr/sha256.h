...
public:
  ...
  static bool sha256file(const char *name, size_t *charCount, unsigned char hashResult[32]);

  static std::string bytesHashToStringHash(const unsigned char sha256[32]);
